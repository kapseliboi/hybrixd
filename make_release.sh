...
$MINIFY lib/functions.js --output $OUTPATH/lib/functions.js
$MINIFY lib/globals.js --output $OUTPATH/lib/globals.js
$MINIFY lib/storage.js --output $OUTPATH/lib/storage.js
#$MINIFY lib/underscore.js --output $OUTPATH/lib/underscore.js
...
$CSSMIN views/interface/css/style.css > $OUTPATH/views/interface/css/style.css
