...
function timestamp(currentdate) {
	var datetime =  currentdate.getFullYear() + '-'
					...
					+ currentdate.getDate().toString().lZero(2) + ' '  
					+ currentdate.getHours().toString().lZero(2) + ':'  
					+ currentdate.getMinutes().toString().lZero(2) + ':' 
					+ currentdate.getSeconds().toString().lZero(2) + '.'
					+ currentdate.getMilliseconds().toString().lZero(3);
	return datetime;
}
