      ...
      if (timeout > timenow && global.hybridd.APIqueue[qid].retries < global.hybridd.APIqueue[qid].retry) {
        ...
        if (global.hybridd.APIqueue[qid].next < timenow && global.hybridd.APIthrottle[base] < timenow) {
          ...
          try {
            ...
            if(global.hybridd.APIqueue[qid].link){ // If the link is already defined
              ...
              var options = {}
              if(global.hybridd.APIqueue[qid].user) { options.user = global.hybridd.APIqueue[qid].user; }
              if(global.hybridd.APIqueue[qid].pass) { options.password = global.hybridd.APIqueue[qid].pass; }
