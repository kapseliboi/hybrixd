            ...
            if (timeout > timenow && global.hybridd.APIqueue[qid].retries < global.hybridd.APIqueue[qid].retry) {
                ...
                if (global.hybridd.APIqueue[qid].next < timenow && global.hybridd.APIthrottle[base] < timenow) {
                    ...
                    try {
                        ...
                        switch (method) {
                          case 'POST':
                            postresult = restAPI.post(host, args, function (data, response) {
                            ...
                            break;
                          case 'PUT':
                            postresult = restAPI.put(host, args, function (data, response) {
                            ...
                            break;
                          case 'GET':
                            postresult = restAPI.get(host+'/'+args.path, {}, function (data, response) {
