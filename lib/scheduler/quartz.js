 ...
 */
  this.jump = function (p, stepto) {
    ...
    global.hybridd.proc[p.processID].busy = false;
    global.hybridd.proc[p.processID].progress = 1;
    global.hybridd.proc[p.processID].data = global.hybridd.proc[p.processID].data;
 ...
 */
  this.tran = function (p, property, is_valid, is_invalid) {
    ...
    if (checkVar.valid) {
      this.jump(p, is_valid, checkVar.data);
    } else {
      this.jump(p, is_invalid || 1, testObject);
    }
  };
  /**
 ...
 * form(4)    // input: 8, output: "0.8000"
  */
  this.form = function (p, factor) {
    ...
    console.log('FORM DATA: ' + global.hybridd.proc[p.processID].data);
    console.log('FORM FACT: ' + factor);
