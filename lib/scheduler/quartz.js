  ...
  this.func = function (p, funcname, xdata) { // TODO remove legacy xdata
    ...
    if (!modules.module.hasOwnProperty(moduleID)) {
      ...
      if (typeof xdata !== 'undefined') {
        ...
        modules.module[moduleID].main[ funcname ]({pass, done, stop, fail}, ydata);
      }
    }
  };
