 ...
 */
  this.poke = function (p, key, pdata, xdata) {
    ...
    var ydata = typeof xdata === 'undefined' ? qdata : xdata;
 ...
 */
  this.peek = function (p, key) {
    ...
    if (keySplit.length === 2) {
      ...
      pdata = process.command ? process.command[key] : undefined;
    } else {
      pdata = process.recipe[key];
    }
    this.next(p, 0, pdata);
  };
  /**
