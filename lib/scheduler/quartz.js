 ...
 *  sort([10,8,5,9],'desc')                         // sorts the object descending by value: [10,9,8,5]
 ...
 *  sort({'a':1,'b':10,'c':3},['val','num','asc'])  // sorts the object ascending by numeric value:  [{'a':1},{'c':3},{'b':10}]
 *  sort([{'a':4,'b':'B'},{'a':2,'b':'A'}],['obj:b'])   // sorts the array by object key 'b': [{'a':2,'b':'A'},{'a':4,'b':'B'}]
 */
