...
exports.repl = input => function (p, srch, repl, modifiers) {
  ...
  if (typeof srch === 'undefined') {
      ...
      return this.fail('repl: Expected search parameter to be a string or array!');
  }
  if (typeof repl === 'undefined') {
      repl = '';
  } else if (modifiers && typeof repl !== 'string') {
      return this.fail('repl: Expected regular expression replace parameter to be a string!');
  } else if (!modifiers && typeof repl !== 'string' && !(repl instanceof Array)) {
      return this.fail('repl: Expected replace parameter to be a string or array!');
  }
