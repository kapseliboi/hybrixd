...
function convertParameter (resolvedParameter) {
  ...
  if (resolvedParameter.startsWith('"')) { // "string"
    ...
    result = parseString(resolvedParameter, '`');
  } else if (resolvedParameter.startsWith('[') && !resolvedParameter.startsWith('[]')) { // [array] with exception of [] for tran
  ...
  } else if (!isNaN(resolvedParameter) && !resolvedParameter.startsWith('+') && !resolvedParameter.startsWith('.')) { // number
