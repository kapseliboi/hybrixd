...
function QrtzParameter (parameter, useWithhoutParsing) {
  ...
  if (useWithhoutParsing) {
    ...
    this.getRunTime = processStep => {
      // TDO improve encapsulation of processStep methods: pass processStep and let subfunctions of parseParamter use methods
      ...
      if (parameterResult.error) {
        throw parameterResult.error; // TODO Needs to be caught
      } else {
