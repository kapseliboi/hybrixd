...
var next = function(processID) {
  if(global.hybridd.proc[processID].stopped){return false;}
  ...
  if(!global.hybridd.proc.hasOwnProperty(subprocessID)){return false;}
...
exports.next = next; // queue subprocess steps
