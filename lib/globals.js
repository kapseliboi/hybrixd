...
Decimal = require('../common/crypto/decimal-light.js');
Decimal.set({precision: 64}); // cryptocurrencies (like for example Ethereum) require extremely high precision!
DJB2 = require('../common/crypto/hashDJB2'); // fast DJB2 hashing
hex2dec = require('../common/crypto/hex2dec'); // convert long HEX to decimal
...
padFloat = function (input, factor) { // "12.34" => "12.34000000" (Number of decimals equal to factor)
  var f = Number(factor);
  var x = new Decimal(String(input));
