...
console.log(result);
       if(result.hasOwnProperty('progress') && result.progress!==1){
...
`;
  ...
  data += '<div id="console-wrapper"><div id="console-header">API Console  <span id="console-close" class="close" onclick="toggleConsole();">Show</span></div><div id="console-results"></div><div class="prompt"> >> <input class="text" type="text" onkeyup="if(event.keyCode===13){rout(event.target.value);event.target.value=\'\';}"/></div></div>';
