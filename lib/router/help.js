...
function apiEdit (xpath, exec) {
  if (exec) {
    ...
    data += '<input type="submit" value="execute" onclick="window.open( window.location.protocol + \'//\' + window.location.host  + (window.location.pathname.startsWith(\'/api\') ? \'/api\' : \'\')' + varData + ');">';
    return data;
  } else {
