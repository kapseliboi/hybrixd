...
function html (rootPath, sessionID) {
  ...
  tree['_help'] = `<p>Welcome to the Hybridd API.</p>

This Application Programming Interface can be used to retrieve information from Hybridd. The requests are formated as / seperated commands.
...
<p><b>Examples</b></p>
<ul>
<li><code><span style="color:blue">/asset</span></code> returns the assets supported by the hybridd node.</li>
...
<li><code>/command/reload</code> reload hybridd and reinitialize modules and recipes.</li>
<li><code><span style="color:green">/proc</span></code> returns the list of processes running on the hybridd node.</li>
...
<p><code>{"error":0,"info":"Process data.","id":"<span style="color:orange;">1543921378626236</span>","progress":1,"started":1543923093402,"stopped":1543923093695,"data":"<span style="color:orange;">0.00000000</span>","request":"<span style="color:blue">/asset/btc/balance/32FCGFdRGeho2HBeWQPaAYawJfPqHHvsCJ</span>"}</code></p>

<p><b>hybridd-lib.js : a Javascript Library</b></p>
...
<p><a href="/api/help/hybrid-lib.js">Learn more...</a></p>
