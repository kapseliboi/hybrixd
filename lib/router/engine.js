...
var process = function process (request, xpath) {
  ...
  if (xpath.length === 1) {
    ...
    result = {
      ...
      "error": 0,
      "id": "engine",
      "info": "List of available engines."
    };*/
    ...
    if ([
      "storage"
    ].indexOf(xpath[1]) > -1 || typeof target !== "undefined" ) {  // Object.keys(enginelist(xpath[1], xpath[2]).data).indexOf(command) > -1)
      ...
      } else if (pathsengineExec.indexOf(command) > -1) {
