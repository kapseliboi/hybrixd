...
function handleRequest (request) {
  ...
  if (JSON.stringify(xpath) !== JSON.stringify(last_routed_xpath) && xpath[0] !== 'y' && xpath[0] !== 'z') {
    console.log(' [i] routing request /' + xpath.join('/'));
  }
  last_routed_xpath = xpath; // used to prevent double console.log on repeated calls
