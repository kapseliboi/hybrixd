...
function serve (request, xpath) {
  ...
  if (path === '/report' || path === '/report/log' || path === '/report/sessions' || path === '/report/api' || path === '/report/api/assets' || path === '/report/assets') {
    ...
    // Asset test reports
  } else if (xpath.length === 3 && xpath[1] === 'assets' && xpath[2] === 'cron') {
    ...
    return getAssets(JSON.stringify);
  } else if (xpath.length === 3 && xpath[1] === 'assets' && xpath[2] === 'cli') {
    return getAssets(data => test.cli(data));
  } else if (xpath.length === 3 && xpath[1] === 'assets' && xpath[2] === 'html') {
    return getAssets(data => test.web(data));
    // API/ASSET
