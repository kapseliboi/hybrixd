...
function createResponse(request, response){
  ...
  if(typeof result['type'] === 'undefined' || result['type'] === 'application/json' || result['type'] === 'text/plain'){
    // TODO text/plain is currently used by storage and deterministic to pass file data as the data property of the result json
    //  Maybe create a specific type for that
