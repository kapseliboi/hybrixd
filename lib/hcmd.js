...
let confFile;
if (ops.conf) {
  if (ops.conf.startsWith('/')) confFile = ops.conf;
  else confFile = '../' + ops.conf;
} else confFile = '../hybrixd.conf';

if (!conf.setup(confFile)) console.error(' [!] Error: Configuration file ' + confFile + ' not found.');
