var proofOfWork = (function() {
    ...
    create : function(difficulty) {
      ...
      var hash='';
      for(i=0;i<5;i++) {
        hash+=DJB2.hash('w1iV++8Paiz1W/JPPasdRTiHiPaZkF3L5fQBpl/EsMsAAAA='+i+'braNzUosoR/WGHdjuE3vgOzS3vAm0yeHdryKUKfqMzOZrnnxM2j0ZBtosjbG+BpuoONa0SSg0g1a'+String(Math.random()*(Math.random()*1000000))+'H4sIALBvLloCA02OMQ4CMQwEe16xD0B8gIqKhk9YspOzyMUo8d2J35OYAgoX691Z+1YZtjkswRdB');
      }
      var sffx=DJB2.hash(String('rFGlQjLECtkQ7Lt2mCc+NCV4wbqX9VJehLZIsQGVN91vP+SUxmyOAAAA'+pow+hash+'y37v4RNP7wiH+kEdyYTTp/alYktUHe0gsATc9IuVhmeS4eX2/5zs4XTQ'+pow.split("").reverse().join("")+'H4sIAHBsLloCAy2M0Q3CQAxD/5nCA1SMAQMwwVUXLpHSBF3SVmxPKvFn'));
      return {hash:hash+sffx,proof:DJB2.hash('PowerToThePeople_'+pow)};
    },
