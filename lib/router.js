  ...
  if (typeof request.url === 'string') {
    ...
    if (xpath.length === 0) {
      ...
      /* Result should be one of the following
         ...
         - - id
         - - request
         - A result file object containing:
         - - error
         - - file
         - - info
         - - id
      ...
      if (typeof result === 'object' && result.hasOwnProperty('file')) { // Handle flat files
        var fileName = '../' + result['file']; // 'file://*' => file : '$HYBRIDD_HOME/*'
...
console.log(partialFSReadSync(__filename, 25, 71).toString());
*/
        // TODO read file
