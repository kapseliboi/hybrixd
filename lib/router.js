...
//network = require("./network");//?/router
...
// routing handler
// reserved letters: a asset, c command, f function, n network info, p proc, s source, v views, x xauth
...
function route(request,modules) {
  ...
  if(typeof request.url === "string") {
	...
	result = asset.process(request,xpath);
      ...
      // routing commands
      if(xpath[0] === "c" || xpath[0] === "command") {
        result = command.process(request,xpath);
      }
      // instant lists
