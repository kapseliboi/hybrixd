...
var evaluate = function evaluate (runprocess, p, err, data) {
    ...
    function func(p,module,funcname,funcdata,data) {
      ...
      // DEPRECATED: eval("modules.module."+module+".main."+funcname+"("+JSON.stringify(funcdata)+");");
      ( new Function("modules.module."+module+".main."+funcname+"("+JSON.stringify(funcdata)+");") )();
      // try {
