...
export var receiveAsset = {
  renderAssetDetailsInModal: function (assetID) {
    ...
    clipboardButton('#modal-receive-button', clipboard.onSuccess, clipboard.onError); // set function of the copy button
...
export var resetReceiveStatusStream = fromEvent(document.querySelector('.receiveAssetCloseBtn'), 'click')
  .pipe(
    tap(resetReceiveStatus)
  );
