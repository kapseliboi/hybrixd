...
var folder = __dirname + '/var/prices';
...
function parse () {
  var sourcesOut = combineQuoteSources([parseEUCentralBank(folder), parseHitbtc(folder), parseBinance(folder), parseCoinmarketcap(folder), parseCoinbase(folder)]);
