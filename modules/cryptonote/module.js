...
function exec(properties) {
  ...
  case 'transfer':
    ...
    var payment_id = randomstring(64,'abcdef1234567890')	// create a random number/lowercase string
  ...
  case 'listtransactions':
    ...
    break;
  case 'chart':
    /*  Below follows an example array for chart data.
        ...
        volume: +d.Volume
    */
    subprocesses.push('stop(0,[ [\'00:00:00 01-01-2016\',20,30,15,25,100] , [\'00:00:00 02-01-2016\',20,60,25,35,140] , [\'00:00:00 01-01-2016\',40,80,35,65,180] ]);');
    break;
  default:
...
function link(properties) {
  ...
  var postresult = restcoin.post('http://'+target.host+':'+target.port+'/'+mainpath, args,  function(data, response) {
    ...
    global.hybridd.proc[processID].data=data;
    global.hybridd.proc[processID].progress=1;
    global.hybridd.proc[processID].stopped=Date.now();
  });
