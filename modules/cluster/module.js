  ...
  switch (command[0]) {
    ...
    case 'command' :
      ...
      for (var peer in peers) {
        subprocesses.push("curl('http://" + peers[peer] + "','/" + xpath.join('/') + "','GET',{},{parsing:'none',autoproc:true})");//
      }
    ...
    case 'status' :
      for (var peer in peers) {
        subprocesses.push("curl('http://" + peers[peer] + "','/engine/cluster/peers','GET',{},{parsing:'none',autoproc:true})");
      }
      subprocesses.push('coll(' + peers.length + ')');
    ...
    case 'propose' :
      ...
      if (captain === null) { // Yah, I'm the captain
        ...
        subprocesses.push("curl('http://" + peers[peer] + "','/e/cluster/propose/" + key + '/' + value + "','GET',{},{autoproc:true})");
      }
