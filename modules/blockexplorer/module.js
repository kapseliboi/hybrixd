  ...
  var command = properties.command;
    ...
    case 'blockr':
      switch(command[0]) {
        ...
        case 'unspent':
          ...
          if(typeof command[1]!='undefined') {
            subprocesses.push('func("blockexplorer","link",{target:'+jstr(target)+',command:["address","unspent",'+jstr(command[1])+']})');
    ...
    case 'insight':
      switch(properties.command[0]) {
        ...
        break;
        case 'balance':
            subprocesses.push('func("blockexplorer","link",{target:'+jstr(target)+',command:["addr",'+jstr(command[1])+',"balance"]})');
            subprocesses.push('func("blockexplorer","link",{target:'+jstr(target)+',command:["addr",'+jstr(command[1])+',"unconfirmedBalance"]})');
        ...
        case 'unspent':
          ...
          if(typeof command[1]!='undefined') {
            subprocesses.push('func("blockexplorer","link",{target:'+jstr(target)+',command:["addr",'+jstr(command[1])+',"utxo"]})');
            subprocesses.push('func("blockexplorer","post",{target:'+jstr(target)+',command:'+jstr(command)+',data:data})');
          } else {
            subprocesses.push('stop(1,"Please specify an address!")');
          }
    ...
    case 'abe':
      switch(properties.command[0]) {
        ...
        case 'unspent':
          ...
          if(typeof command[1]!='undefined') {
            subprocesses.push('func("blockexplorer","link",{target:'+jstr(target)+',command:["unspent",'+jstr(command[1])+'],nopath:true})');
            subprocesses.push('func("blockexplorer","post",{target:'+jstr(target)+',command:'+jstr(command)+',data:data})');
          } else {
            subprocesses.push('stop(1,"Please specify an address!")');
          }
